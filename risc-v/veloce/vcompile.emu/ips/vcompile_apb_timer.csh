...
echo "${Red}"
velanalyze -hdl verilog -sv -quiet -work ${LIB_PATH}     ${IP_PATH}/apb_timer.sv || goto error
velanalyze -hdl verilog -sv -quiet -work ${LIB_PATH}     ${IP_PATH}/timer.sv || goto error
