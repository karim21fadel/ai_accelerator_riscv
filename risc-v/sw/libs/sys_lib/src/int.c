...
// 19: can4 interrupt test
__attribute__ ((weak))
void ISR_CAN_4 (void){ for(;;); }

// 20: can3 interrupt test
__attribute__ ((weak))
void ISR_CAN_3 (void){ for(;;); }

// 21: can2 interrupt test
__attribute__ ((weak))
void ISR_CAN_2 (void){ for(;;); }

// 22: can1 interrupt test
__attribute__ ((weak))
void ISR_CAN_1 (void){ for(;;); }
